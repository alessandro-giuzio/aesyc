        ...
        <div class="flex flex-col gap-8">
            ...
            <div class="flex flex-col  items-start gap-4">
                <div class="flex flex-col items-start">
                    <h2 class="text-2xl md:text-4xl text-txPri font-bold md:leading-[56px] max-w-xl">Lorem <span class="text-primary-0">Ipsum Dolor</span> Sit Amet at vero es et <span class="text-primary-0">accusam justo</span></h2>
                </div>
