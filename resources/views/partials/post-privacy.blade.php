<article class="prose lg:prose-xl">
    <h4 class="text-sm text-txPri font-bold leading-6">
        Datenschutz</h4>
    <p class="text-sm text-txPri font-normal leading-6">
    ...
    <h4 class="text-sm text-txPri font-bold leading-6">Auskunft, Löschung, Sperrung</h4>
    <p class="text-sm text-txPri font-normal leading-6">
    Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden.
    </p>
    <h4 class="text-sm text-txPri font-bold leading-6">Kontaktformular</h4>
    <p class="text-sm text-txPri font-normal leading-6">
    Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
    </p>
    <h4 class="text-sm text-txPri font-bold leading-6">Widerspruch Werbe-Mails</h4>
    <p class="text-sm text-txPri font-normal leading-6">
    Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten zur Übersendung von nicht ausdrücklich angeforderter Werbung und Informationsmaterialien wird hiermit widersprochen. Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch Spam-E-Mails, vor.
    </p>
    <h4 class="text-sm text-txPri font-bold leading-6">Hotjar</h4>
    <p class="text-sm text-txPri font-normal leading-6">
    ...
    <p class="text-sm text-txPri font-normal leading-6">
        Geräte abhängige Daten <br>
    Die folgenden Informationen können durch Ihr Gerät und Ihren Browser aufgezeichnet werden:
    </p>
    <ol class="text-sm text-txPri font-normal leading-6 list-disc">
        <li>
    ...
    <h4 class="text-sm text-txPri font-bold leading-6">Log Daten</h4>
    <p class="text-sm text-txPri font-normal leading-6">
    ...
    <p class="text-sm text-txPri font-normal leading-6">Hotjar wird diese      Informationen nutzen um Ihre Nutzung unserer Website auszuwerten, Berichte der Nutzung zu erstellen, sowie sonstige Dienstleistungen, die die Websitebenutzung und Internetauswertung der Website betreffen. Hotjar benutzt zur Leistungserbringung auch Dienstleistungen von Drittunternehmen, wie beispielsweise Google Analytics und Optimizely. Diese Drittunternehmer können Informationen, die Ihr Browser im Rahmen des Website-Besuches sendet, wie beispielsweise Cookies oder IP-Anfragen, speichern. Für nähere Informationen, wie Google Analytics und Optimizely Daten speichern und verwenden, beachten Sie bitte deren entsprechende Datenschutzerklärungen.
        </p>
        <p class="text-sm text-txPri font-normal leading-6">
        ...
        <p class="text-sm text-txPri font-normal leading-6">
    Sie können die Erfassung der Daten durch Hotjar verhindern, indem Sie auf folgenden Link klicken und die dortigen Instruktionen befolgen:<span class="text-primary-0"> https://www.hotjar.com/opt-out.</span></p>

    <h4 class="text-sm text-txPri font-bold leading-6">Google reCAPTCHA</h4>
    <p class="text-sm text-txPri font-normal leading-6">
