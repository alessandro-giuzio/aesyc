    ...
    <div class="md:basis-1/2 mx-auto relative">
      ...
      <div class="absolute top-72 left-10 md:top-120 flex space-x-10">
        ...
        >
          ...
          <div class="bg-primary-0 py-2 px-4 rounded-xl flex self-start items-center justify-center">
            ...
            <div>
              <a
                href="tel:+123456678"
                class="text-base text-bg1 font-semibold leading-4 md:leading-6"
              >
                +123456789-0
              </a>
            </div>
        ...
        <div class="hidden xl:flex flex-col space-y-10.4 items-center">
          ...
          <div
            class="rounded-lg bg-primary-0 px-4 py-2 flex items-center gap-2"
          >
            <div class="h-6 w-6">
            ...
            <div>
              <a
                href="mailto:je@aesyc.systems"
                class="text-lg text-bg1 font-bold leading-6"
              >
              je@aesyc.systems
              </a>
            </div>
      ...
      <div class="form-container">
        <div class="form-header flex flex-col gap-6">
          ...
          <div class="flex gap-6">
            <a href="#"
              ><img src="@asset('/images/contact/twitter.png')" alt=""
            /></a>
        ...
        <div class="form">
          <form action="">
            <div class="input-animated">
              <label for="name" class="w-full label-name"
                ><span class="content-name w-full text-xs text-txSec font-bold leading-4"
                  >Dein Name</span
                ></label
              >
              <input
            ...
            <div class="input-animated">
              <label for="email" class="w-full label-name"
                ><span class="content-name w-full text-xs text-txSec font-bold leading-4"
                  >Deine E-Mail Adresse</span
                ></label
              >
              <input
                type="text"
          ...
          <div class="input-animated">
            <input
              ...
              name="checkbox"
              id=""
              class="checked:bg-primary-0"
            />
            <label for="checkbox" class="text-base text-txSec font-normal leading-5"
          ...
          @include('components.button' , ['text' => 'Nachricht senden'])
         {{--  <button
            type="submit"
            id="submit-button"
